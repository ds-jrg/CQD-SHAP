...
def score_queries(args):
    ...
    if args.sample:
        data_hard_path = osp.join(args.path, f'{dataset}_{mode}_hard_sample.pkl')
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--sample', type=bool, default=False,
                        help='If True, use sampled queries (just one query)')
    parser.add_argument('--result_path', type=str, default='scores.pt',
